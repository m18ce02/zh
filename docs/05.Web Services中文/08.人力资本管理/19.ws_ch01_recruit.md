...
permalink: /pages/10507b/
meta:
  - name: description
    content: 學習使用HRMS系統/HRIS的招聘管理。 瀏覽、參考、範例程式碼、教學課程及更多資源。
  - name: keywords
    content: 招聘管理, HRMS, HRIS, HCM, HR system, HR software.
---
...
4.  返回示例
    ...
    ![REQREQ_EBI](/zh/assets/hcm/REQREQ_EBI.png)
...
4.  返回示例
    ...
    ![REQACT_EBI](/zh/assets/hcm/REQACT_EBI.png)
...
4.  返回示例
    ...
    ![JOBAPP_EBI](/zh/assets/hcm/JOBAPP_EBI.png)
...
3.  返回示例
    ...
    ![JOBASSESS_EBI](/zh/assets/hcm/JOBASSESS_EBI.png)
...
4.  返回示例
    ...
    ![ACTEXPENSE_EBI](/zh/assets/hcm/ACTEXPENSE_EBI.png)
...
4.  返回示例
    ...
    ![RESUME_EBI](/zh/assets/hcm/RESUME_EBI.png)
...
4.  返回示例
    ...
    ![RESUMENOTE_EBI](/zh/assets/hcm/RESUMENOTE_EBI.png)
