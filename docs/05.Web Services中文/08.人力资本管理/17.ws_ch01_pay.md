...
meta:
  - name: description
    content: 學習使用HRMS系統/HRIS的薪资管理。 瀏覽、參考、範例程式碼、教學課程及更多資源。
  - name: keywords
    content: 薪资管理, HRMS, HRIS, HCM, HR system, HR software.
---
...
4. 返回示例
   ...
   ![EMPFIXPAY_EBI](/zh/assets/hcm/EMPFIXPAY_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPVARPAY_EBI](/zh/assets/hcm/EMPVARPAY_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYRESULTVAL_EBI](/zh/assets/hcm/PAYRESULTVAL_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPPAYPARA_EBI](/zh/assets/hcm/EMPPAYPARA_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYWAREHOUSE_EBI](/zh/assets/hcm/PAYWAREHOUSE_EBI.jpg)
...
4. 返回示例
   ...
   ![FINALPAY_EBI](/zh/assets/hcm/FINALPAY_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPCOSTAMOR_EBI](/zh/assets/hcm/EMPCOSTAMOR_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYROLLAMOR_EBI](/zh/assets/hcm/PAYROLLAMOR_EBI.png)
...
4. 返回示例
   ...
   ![SALARYPACKAGE_EBI](/zh/assets/hcm/SALARYPACKAGE_EBI.jpg)
...
4. 返回示例
   ...
   ![SALARYPACKPARA_EBI](/zh/assets/hcm/SALARYPACKPARA_EBI.jpg)
...
4. 返回示例
   ...
   ![MONTHPAYRECON_EBI](/zh/assets/hcm/MONTHPAYRECON_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPPAYINFOLIST_EBI](/zh/assets/hcm/EMPPAYINFOLIST_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPIR56INFO_EBI](/zh/assets/hcm/EMPIR56INFO_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPMPFINFO_EBI](/zh/assets/hcm/EMPMPFINFO_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYRESULTVAL_MPF_EBI](/zh/assets/hcm/PAYRESULTVAL_MPF_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYWAREHOUSE_MPF_EBI](/zh/assets/hcm/PAYWAREHOUSE_MPF_EBI.jpg)
...
4. 返回示例
   ...
   ![FINALPAY_MPF_EBI](/zh/assets/hcm/FINALPAY_MPF_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPINSUR_EBI](/zh/assets/hcm/EMPINSUR_EBI.jpg)
...
4. 返回示例
   ...
   ![INSSUMREP_EBI](/zh/assets/hcm/INSSUMREP_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYSCALE_EBI](/zh/assets/hcm/PAYSCALE_EBI.jpg)
...
4. 返回示例
   ...
   ![RANK_DETAIL_EBI](/zh/assets/hcm/RANK_DETAIL_EBI.jpg)
...
4. 返回示例
   ...
   ![PAYWAREHOUSE_NGO_EBI](/zh/assets/hcm/PAYWAREHOUSE_NGO_EBI.jpg)
...
4. 返回示例
   ...
   ![EMPRANKCODE_EBI](/zh/assets/hcm/EMPRANKCODE_EBI.jpg)
...
4. 返回示例
   ...
   ![CLAIM_EBI](/zh/assets/hcm/CLAIM_EBI.jpg)
