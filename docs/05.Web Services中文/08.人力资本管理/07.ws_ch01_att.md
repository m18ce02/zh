...
meta:
  - name: description
    content: 學習使用HRMS系統/HRIS的考勤管理。 瀏覽、參考、範例程式碼、教學課程及更多資源。
  - name: keywords
    content: 考勤管理, HRMS, HRIS, HCM, HR system, HR software.
---
...
4.  返回示例
    ...
    ![ATTRESULT_EBI](/zh/assets/hcm/ATTRESULT_EBI.jpg)
...
4.  返回示例
    ...
    ![BRIEFATTRESULT_EBI](/zh/assets/hcm/BRIEFATTRESULT_EBI.jpg)
...
4.  返回示例
    ...
    ![DETAILATTREP_EBI](/zh/assets/hcm/DETAILATTREP_EBI.jpg)
...
4.  返回示例
    ...
    ![ATTSUMMARY_EBI](/zh/assets/hcm/ATTSUMMARY_EBI.jpg)
...
4.  返回示例
    ...
    ![TIMECARDREC_EBI](/zh/assets/hcm/TIMECARDREC_EBI.jpg)
...
4.  返回示例
    ...
    ![OTTOLEAVE_EBI](/zh/assets/hcm/OTTOLEAVE_EBI.jpg)
...
4.  返回示例
    ...
    ![UNEXP_TIMECARD_EBI](/zh/assets/hcm/UNEXP_TIMECARD_EBI.jpg)
...
4.  返回示例
    ...
    ![SHIFTREGULA_EBI](/zh/assets/hcm/SHIFTREGULA_EBI.jpg)
...
4.  返回示例
    ...
    ![SHIFTSET_EBI](/zh/assets/hcm/SHIFTSET_EBI.jpg)
...
4.  返回示例
    ...
    ![ROSTERLIST_EBI](/zh/assets/hcm/ROSTERLIST_EBI.jpg)
...
4.  返回示例
    ...
    ![OTAPP_EBI](/zh/assets/hcm/OTAPP_EBI.jpg)
...
4.  返回示例
    ...
    ![DAILYATTLOG_EBI](/zh/assets/hcm/DAILYATTLOG_EBI.jpg)
...
4.  返回示例
    ...
    ![DETAILATTSUM_EBI](/zh/assets/hcm/DETAILATTSUM_EBI.jpg)
...
4.  返回示例
    ...
    ![TIMECARDLOG_EBI](/zh/assets/hcm/TIMECARDLOG_EBI.jpg)
...
4.  返回示例
    ...
    ![ROSTERLOG_EBI](/zh/assets/hcm/ROSTERLOG_EBI.jpg)
