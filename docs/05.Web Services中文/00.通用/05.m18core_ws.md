...
`GET http://127.0.0.1:8080/jsf/rfws/attach/tableField/getAllDataDict`
...
`GET http://127.0.0.1:8080/jsf/rfws/attach/tableField/getTableFields?moduleType=[module type]&menuCode=[menu code]&table=[table name]`
