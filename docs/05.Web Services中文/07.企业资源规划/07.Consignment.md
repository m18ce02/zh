...
meta:
  - name: description
    content: 學習使用ERP系統的委外代销。瀏覽、參考、範例程式碼、教學課程及更多資源。
  - name: keywords
    content: 委外代销, ERP, ERP software, ERP system, ERP solution.
---
## 委外代销订单
...
![ebi1](/zh/assets/erp/consignCdn_ebi_1.jpg)
...
![ebi1](/zh/assets/erp/consignCsr_ebi_1.jpg)
