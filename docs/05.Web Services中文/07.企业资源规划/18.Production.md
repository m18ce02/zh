...
meta:
  - name: description
    content: 學習使用ERP系統的生产。瀏覽、參考、範例程式碼、教學課程及更多資源。
  - name: keywords
    content: 生产, ERP, ERP software, ERP system, ERP solution.
---
## 主生产工单
...
![ebi2](/zh/assets/erp/prodPick_ebi_2.jpg)
...
![ebi2](/zh/assets/erp/prodPr_ebi_2.jpg)
...
![ebi2](/zh/assets/erp/prodPw_ebi_2.jpg)
